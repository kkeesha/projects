...
import personalaccountant.model.*;
...
public class PersonalAccountant {
    ...
    private static void init() {
        try {
            ...
            Logger.getLogger(PersonalAccountant.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

    private static void testModel() throws ModelException {
        Currency c1 = new Currency("Ruble", "RUB", 1, true, true);
        Currency c2 = new Currency("Dollar", "USD", 85, true, false);
        Currency c3 = new Currency("Euro", "EUR", 95, false, false);
        Currency c4 = new Currency("Som", "KGS", 0.9, false, false);
        
        Account ac1 = new Account("Wallet", c1, 1000);
        ...
        Article article1 = new Article("Grocery");
        Article article2 = new Article("Flat utilities");
        Article article3 = new Article("Salary");
        Article article4 = new Article("Canteen");
        Article article5 = new Article("Deposit rate");
        ...
        transactions.add(new Transaction(ac2, article1, -1500, "For the weekend"));
        transactions.add(new Transaction(ac1, article2, -5500, "Main flat rent"));
        transactions.add(new Transaction(ac1, article2, -4000, "Second flat rent"));
