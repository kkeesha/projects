...
final public class Text {
    ...
    public static String get(String key) {
        ...
        //System.out.println("No such key exists in Text!"); // Для отладки
        return "";
    }
    ...
    public static void init() {
        if (Settings.getLanguage().equals("ru")) {
            ...
            data.put("RU_RUBLE", "Рубль");
            data.put("RU_DOLLAR", "Доллар");
            data.put("RU_SOM", "Сом");
            data.put("RU_FORINT", "Форинт");
            data.put("RU_EURO", "Евро");
            ...
            data.put("PROGRAMM_NAME", "Personal Accountant");
            ...
            data.put("EN_RUBLE", "Ruble");
            data.put("EN_DOLLAR", "Dollar");
            data.put("EN_SOM", "Som");
            data.put("EN_FORINT", "Forint");
            data.put("EN_EURO", "Euro");
