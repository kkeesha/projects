...
final public class Style {
    ...
    public static final Font FONT_BUTTON_TOOLBAR = new Font("Clear Sans", Font.BOLD, 16);
    public static final Font FONT_MAIN_BUTTON = new Font("Clear Sans", Font.BOLD, 16);
    public static final Font FONT_DIALOG_LABEL = new Font("Clear Sans", Font.BOLD, 14);
    public static final Font FONT_LABEL_HEADER = new Font("Clear Sans", Font.BOLD, 18);
    public static final Font FONT_LABEL_LEFT_PANEL_CURRENCY = new Font("Clear Sans", Font.BOLD, 16);
    public static final Font FONT_LABEL_LEFT_PANEL_AMOUNT = new Font("Clear Sans", Font.PLAIN, 16);
    public static final Font FONT_TABLE_HEADER = new Font("Clear Sans", Font.BOLD, 18);
    public static final Font FONT_TABLE = new Font("Clear Sans", Font.PLAIN, 15);
    public static final Font FONT_BUTTON_FILTER = new Font("Clear Sans", Font.BOLD, 14);
