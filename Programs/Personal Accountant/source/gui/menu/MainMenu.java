...
import personalaccountant.gui.handler.MenuEditHandler;
import personalaccountant.gui.handler.MenuFileHandler;
import personalaccountant.gui.handler.MenuHelpHandler;
import personalaccountant.gui.handler.MenuSettingsHandler;
import personalaccountant.gui.handler.MenuViewHandler;
...
public class MainMenu extends JMenuBar implements Refresh, EnableEditDelete {
    ...
    private void init() {
        ...
        file.setFont(Style.FONT_BUTTON_FILTER);
        edit.setFont(Style.FONT_BUTTON_FILTER);
        view.setFont(Style.FONT_BUTTON_FILTER);
        settings.setFont(Style.FONT_BUTTON_FILTER);
        help.setFont(Style.FONT_BUTTON_FILTER);
